...
|&emsp;&emsp;faceData|||false|string||
|&emsp;&emsp;fingerData|||false|string||
...
|&emsp;&emsp;&emsp;&emsp;faceData||string||
|&emsp;&emsp;&emsp;&emsp;fingerData||string||
...
|&emsp;&emsp;&emsp;&emsp;sex||integer||
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|loginPara|登陆信息|body|true|User管理登陆接口入参|User管理登陆接口入参|
...
| -------- | -------- | ----- |----- | 
|code|0:失败  1:成功|integer(int32)|integer(int32)|
|data|返回数据|User管理登陆接口出参|User管理登陆接口出参|
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|user|修改信息,不改的留空|body|true|User|User|
|&emsp;&emsp;address|||false|string||
|&emsp;&emsp;birthday|||false|string(date)||
|&emsp;&emsp;department|||false|string||
|&emsp;&emsp;describe|||false|string||
